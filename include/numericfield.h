...
#pragma warning( pop )
     ...
     *  @return mixed
     */
    operator uint8_t () const override { return static_cast<uint8_t>(_value); }
    operator uint16_t() const override { return static_cast<uint16_t>(_value); }
    operator uint32_t() const override { return static_cast<uint32_t>(_value); }
    operator uint64_t() const override { return static_cast<uint64_t>(_value); }
    operator int8_t  () const override { return static_cast<int8_t>(_value); }
    operator int16_t () const override { return static_cast<int16_t>(_value); }
    operator int32_t () const override { return static_cast<int32_t>(_value); }
    operator int64_t () const override { return static_cast<int64_t>(_value); }
